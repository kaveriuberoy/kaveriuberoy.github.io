...
### Plot 1 – Bar Chart: Top Aisles Ordered From
...
### Plot 3 – Scatterplot: Most popular products by department.
...
plot_ly(
  ...
  layout(
    title = "Total Orders per Product by Aisle",
    xaxis = list(title = "Aisle", tickangle = -45),
    yaxis = list(title = "Total Orders"),
    margin = list(b = 150)  # extra bottom margin for aisle labels
  )
